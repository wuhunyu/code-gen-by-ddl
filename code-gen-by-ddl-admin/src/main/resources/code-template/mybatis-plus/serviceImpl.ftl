...
public class ${entityTemplate.className}${entityTemplate.suffix}Service extends ServiceImpl<${entityTemplate.className}${entityTemplate.suffix}Mapper, ${entityTemplate.className}${entityTemplate.suffix}> {
